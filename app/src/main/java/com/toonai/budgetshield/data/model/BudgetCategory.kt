...
data class BudgetCategory(
    ...
    /** Budget amount allocated for this category in cents (alias for compatibility) */
    val plannedAmountCents: Long = 0L,

    /** Alias for plannedAmountCents (for consistency) */
    val budgetAmountCents: Long = plannedAmountCents,
    ...
    val remainingCents: Long
        get() = maxOf(0L, plannedAmountCents - spentAmountCents)
